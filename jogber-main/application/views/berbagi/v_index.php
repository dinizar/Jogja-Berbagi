			...
			<div class="col col-xl-12 order-xl-2 col-lg-12 order-lg-1 col-md-12 col-sm-12 col-12">
				...
				<div class="ui-block">
					<div class="news-feed-form">
						...
						<li class="nav-item">
							<a class="nav-link inline-items" data-toggle="tab" href="#tabbarang" role="tab" aria-expanded="true">
						...
						<li class="nav-item">
							<a class="nav-link active inline-items" data-toggle="tab" href="#tabjasa" role="tab" aria-expanded="false">
					...
					<div class="registration-form">
                      <div class="ui-block-content"> 
                        <div class="tab-content">
                    	  <div class="tab-pane" id="tabbarang" role="tabpanel" aria-expanded="true">
							
							<form id="form_post_barang" class="content" enctype="multipart/form-data"  multypart="upload/do_upload" method="POST" action="<?php echo base_url().'/berbagi/insert_jasa';?>">
								<div class="row">
						           <div class="col col-lg-4 col-md-4 col-sm-12 col-12">
								      <div class="form-group label-floating is-empty">
									      <label class="control-label">Judul</label>
									      <input class="form-control" name="judul" placeholder="" type="text" >
								      </div>
								       <div class="form-group label-floating is-empty">
								      ...
								      <div class="form-group">
                                        	...
                                        	<input value="" type="file" name="files[]" class="file-upload__label" id="File-barang" >
                                      </div>
					                </div>
					                <div class="col col-lg-4 col-md-4 col-sm-12 col-12">
								      <div class="form-group label-floating is-select">
									       <label class="control-label">Kategori</label>
									           <select class="selectpicker form-control" name="sub_menu">
									           	<?php foreach($sub_menu_barang as $s){ ?>
								      ...
								      <div class="form-group label-floating is-empty">
									       ...
									       <textarea class="form-control" placeholder="" name="lokasi"></textarea>
								      </div>
                                      <div id="foto-preview-barang" class="post-block-photo">
								      </div>
                                    </div>
                                    <div class="col col-lg-4 col-md-4 col-sm-12 col-12">  
								      <div class="radio">
								         ...
								         <label>
									           <input type="radio" name="optionsRadios"  value="<?php echo $kat->id_kategori?>" checked>
							          ...
							          <div class="form-group with-icon label-floating is-select">
									       ...
									       <input class="form-control" name="nomorwa" value="62" type="text" minlength="11" data-toggle="tooltip" data-placement="top" data-original-title="ganti awalan '0' dengan 62">
									       <i class="fab fa-whatsapp c-whatsapp" aria-hidden="true"></i>
									  </div>
									  <input id="posting" class="btn btn-primary btn-md-2" type="submit" name="submit-post" value="Posting">
						...
						<div class="tab-pane active" id="tabjasa" role="tabpanel" aria-expanded="true">
							
							<form id="form_post_jasa" class="content" enctype="multipart/form-data"  multypart="upload/do_upload" method="POST" action="<?php echo base_url().'/berbagi/insert_jasa';?>">
								<div class="row">
						           <div class="col col-lg-4 col-md-4 col-sm-12 col-12">
								      <div class="form-group label-floating is-empty">
									      <label class="control-label">Judul</label>
								      ...
								      <div class="form-group">
                                        	<label class="control-label">Unggah Gambar</label>
                                        	<input value="" type="file" name="files[]" class="file-upload__label" id="File-jasa" multiple>
                                      </div>
					                </div>
					                <div class="col col-lg-4 col-md-4 col-sm-12 col-12">
								      <div class="form-group label-floating is-select">
									       <label class="control-label">Kategori</label>
									           <select class="selectpicker form-control" name="sub_menu">
									           	<?php foreach($sub_menu_jasa as $s){ ?>
										             <option value="<?php echo $s->id_submenu?>"><?php echo $s->nama_submenu?></option>
										        <?php } ?>
									           </select>
								      </div>
                                      ...
                                      <div id="foto-preview-jasa" class="post-block-photo">
								      </div>
                                    </div>
                                    <div class="col col-lg-4 col-md-4 col-sm-12 col-12">  
								      <div class="radio">
...
<script type="text/javascript">
  /*setInterval(function(){ cek_notif(); }, 3000);

  function cek_notif(){
  	 $.ajax({
		url : '<?php //echo base_url()?>berbagi/cek_notifikasi',                 
...
<script type="text/javascript">
	...
	$('#File-jasa').on('change', function(){ //on file input change
		if (window.File && window.FileReader && window.FileList && window.Blob) //check File API supported browser
		{

			$('#foto-preview-jasa').html(''); //clear html of output element
			...
			$.each(data, function(index, file){ //loop though each file
				if(/(\.|\/)(gif|jpe?g|png)$/i.test(file.type)){ //check supported file type
					...
					fRead.onload = (function(file){ //trigger function on successful read
						return function(e) {
						var img = $('<img/>').attr('src', e.target.result).attr('alt','photo'); //create image element 
						$('div#foto-preview-jasa').append(img); //append image to output element
					};
				})(file);
	...
	$('#File-barang').on('change', function(){ //on file input change
		if (window.File && window.FileReader && window.FileList && window.Blob) //check File API supported browser
		{

			$('#foto-preview-barang').html(''); //clear html of output element
			var data = $(this)[0].files; //this file data
			...
			$.each(data, function(index, file){ //loop though each file
				if(/(\.|\/)(gif|jpe?g|png)$/i.test(file.type)){ //check supported file type
					...
					fRead.onload = (function(file){ //trigger function on successful read
						...
						$('#foto-preview-barang').append(img); //append image to output element
					};
				})(file);
					fRead.readAsDataURL(file); //URL representing the file's data.
				}
...
<script type="text/javascript">
    ...
    moment.locale('id');
    <?php foreach ($unggahan as $key=>$uu){?>
	   
	$('#waktu_unggahan-<?php echo $uu->id_unggahan ?>').html(moment("<?php echo $uu->waktu_unggahan ?>").fromNow());
	$('#waktu_unggahan_notif-<?php echo $uu->id_unggahan ?>').html(moment("<?php echo $uu->waktu_unggahan ?>").fromNow()); 
        ...
        $('#waktu_komentar_notif-<?php echo $c->id_komentar ?>').html(moment("<?php echo $c->waktu_komentar ?>").fromNow());
        <?php }?>
